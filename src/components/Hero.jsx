...
export default function Hero({ onOpenResume }) {
  ...
  return (
    <section id="hero-scroll-container" className="relative w-full bg-[#FAF7F2]" style={{ height: "300vh" }}>
      {/* Sticky container that stays fixed while scrolling through the 300vh */}
      <div className="sticky top-0 w-full h-screen flex flex-col justify-center overflow-hidden pt-16 md:pt-0">
